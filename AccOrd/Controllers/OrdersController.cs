...
namespace AccOrd.Controllers
{
    public class OrdersController : Controller
    {
        private readonly AccOrdContext _context;

        public OrdersController(AccOrdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Orders != null ? 
                          ...
                          Problem("Entity set 'AccOrdContext.Orders'  is null.");
        }
